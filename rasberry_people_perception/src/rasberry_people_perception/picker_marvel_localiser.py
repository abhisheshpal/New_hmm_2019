...
class PickerMarvelLocaliser(object):
    ...
    def __init__(self, hedge_pos_a_topic="/hedge_pos_a", hedge_pose_frame_id="/marvelmind", global_frame_id="/map"):
        ...
        self.topo_localiser = rasberry_people_perception.topological_localiser.TopologicalLoTopologicalNavLoc()

        self.tf_listnener = tf.TransformListener()
        self.tf_listnener.waitForTransform(self.global_frame_id, self.hedge_pose_frame_id)
    ...
    def hedge_pos_a_cb(self, msg):
        ...
        try:
            ...
            self.posestamped_pubs[msg.address].publishe(self.posestamped_msgs[msg.address])
