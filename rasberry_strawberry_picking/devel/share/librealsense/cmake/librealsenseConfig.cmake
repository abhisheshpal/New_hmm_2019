...
if("TRUE" STREQUAL "TRUE")
  set(librealsense_SOURCE_PREFIX /home/owner/workspaces/RASBerry/rasberry_strawberry_picking/src/librealsense)
  set(librealsense_DEVEL_PREFIX /home/owner/workspaces/RASBerry/rasberry_strawberry_picking/devel)
  ...
  set(librealsense_INSTALL_PREFIX /home/owner/workspaces/RASBerry/rasberry_strawberry_picking/install)
...
if(NOT "/home/owner/workspaces/RASBerry/rasberry_strawberry_picking/src/librealsense/include " STREQUAL " ")
  set(librealsense_INCLUDE_DIRS "")
  set(_include_dirs "/home/owner/workspaces/RASBerry/rasberry_strawberry_picking/src/librealsense/include")
  ...
  elseif(NOT "http://www.ros.org/wiki/RealSense " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Matt Curfman <matthew.c.curfman@intel.com>, Sergey Dorodnicov <sergey.dorodnicov@intel.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'librealsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/owner/workspaces/RASBerry/rasberry_strawberry_picking/src/librealsense/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/owner/workspaces/RASBerry/rasberry_strawberry_picking/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "sensor_msgs;image_transport;cv_bridge;roscpp;std_msgs")
