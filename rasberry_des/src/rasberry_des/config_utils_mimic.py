...
get_config_data = rasberry_des.config_utils.get_config_data
...
def get_mimic_des_params(config_file):
    ...
    config_params["n_farm_rows"] = rasberry_des.config_utils.graph_param_to_poly_list("n_farm_rows",
    ...
    config_params["row_nodes"] = get_row_nodes(config_data["row_nodes"],
                                               ...
                                               config_params["n_farm_rows"])
    # yield per node
    config_params["yield_per_node"] = rasberry_des.config_utils.graph_param_list_check("yield_per_node",
                                                                      config_data["yield_per_node"]["value"],
                                                                      config_params["n_polytunnels"],
                                                                      config_params["n_farm_rows"],
